...
export function Footer({ appName, settings }: FooterProps) {
  return (
    <footer className="bg-footer border-t border-border pt-8 pb-6 px-6! md:px-12">
      <div className="mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-4">
          <div className="col-span-2 flex flex-col gap-4">
            ...
            <p className="text-[13px] text-footer-foreground/70 leading-[1.7] max-w-70">
            ...
            {settings?.contactEmail && (
              <p className="text-sm font-medium text-footer-foreground/80">
          ...
          <div className="flex flex-col gap-3.5">
            <p className="text-[11px] font-bold tracking-[0.2em] uppercase text-footer-foreground mb-2">Company</p>
          ...
          {/* Links Column 2*/}
          <div className="flex flex-col gap-3.5">
            <p className="text-[11px] font-bold tracking-[0.2em] uppercase text-footer-foreground mb-2">Legal</p>
